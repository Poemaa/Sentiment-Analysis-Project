    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InfkId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InstitutiEmri = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FakultetiDega = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StatusiAkredititmit = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Analizas", x => x.AnalizaId);
                    table.ForeignKey(
                        name: "FK_Analizas_Feedbakcs_FeedbackId",
                        column: x => x.FeedbackId,
                        principalTable: "Feedbakcs",
                        principalColumn: "FeedbackId",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_Analizas_FeedbackId",
                table: "Analizas",
                column: "FeedbackId");
