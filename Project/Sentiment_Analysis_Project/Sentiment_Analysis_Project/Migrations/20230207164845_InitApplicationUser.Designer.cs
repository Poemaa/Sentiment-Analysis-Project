...
namespace Sentiment_Analysis_Project.Migrations
{
    ...
    [Migration("20230207164845_InitApplicationUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sentiment_Analysis_Project.Areas.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Sentiment_Analysis_Project.Models.Analiza", b =>
                {
                    b.Property<int>("AnalizaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AnalizaId"), 1L, 1);
            ...
            modelBuilder.Entity("Sentiment_Analysis_Project.Models.Infk", b =>
                {
                    ...
                    b.Property<string>("FakultetiDega")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("InstitutiEmri")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Sentiment_Analysis_Project.Areas.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Sentiment_Analysis_Project.Models.Analiza", b =>
                {
                    b.HasOne("Sentiment_Analysis_Project.Models.Feedback", "Feedback")
                        .WithMany("Analizas")
